            ...
            child: Row(
              ...
              children: [
                ...
                _buildPageActionButton(
                  ...
                  label: "Single Page",
                  description:
                      "Display one page at a time for focused reading.",
                  onTap: () {
                    setState(() {
                      _displayLayout = PageDisplayLayout.single;
                    });
                  },
                  color: _displayLayout == PageDisplayLayout.single
                      ? theme.colorScheme.primary
                      : null,
                ),
                _buildPageActionButton(
...
class _PdfPageViewItem extends StatefulWidget {
  ...
  @override
  State<_PdfPageViewItem> createState() => _PdfPageViewItemState();
}
